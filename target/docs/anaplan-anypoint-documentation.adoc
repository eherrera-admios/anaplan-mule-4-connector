:toc:               left
:toc-title:         Anaplan Anypoint Module
:toclevels:         2
:last-update-label!:
:docinfo:
...
= Anaplan Anypoint Module Documentation Reference
...
| Connection a| <<anaplan-config_connection, Connection>>
...
| Name | Type | Description | Default Value | Required
|Name | String | The name for this configuration. Connectors reference the configuration with this name. | | *x*{nbsp}
| Connection a| <<other-config_connection, Connection>>
 | The connection types that can be provided to this configuration. | | *x*{nbsp}
|======================

==== Connection Types
[[other-config_connection]]
===== Connection
...
[[retrieveInfo]]
=== Retrieve Info
`<anaplan-anypoint:retrieve-info>`
...
==== Throws
* ANAPLAN-ANYPOINT:CONNECTIVITY {nbsp}
* ANAPLAN-ANYPOINT:RETRY_EXHAUSTED {nbsp}


[[sayHi]]
=== Say Hi
`<anaplan-anypoint:say-hi>`
